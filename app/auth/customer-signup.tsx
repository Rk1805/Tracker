...
export default function CustomerSignupScreen() {
  ...
  const { user, appUser, isReady, customerSignup, verifyPhoneOTP } = useAuth();
  ...
  const handleSendOTP = async () => {
    ...
    setLoading(true);
    try {
      await customerSignup(formattedPhone, displayName.trim());
      setShowOtp(true);
    } catch (error: any) {
  ...
  return (
    ...
    >
      <View style={styles.content}>
        ...
        <Text style={styles.subtitle}>Create your account to track deliveries</Text>
